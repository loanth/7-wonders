    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="shadow-2xl">
          <CardHeader>
            <CardTitle className="text-3xl">Énigme 4</CardTitle>
            <CardDescription>
          ...
          <CardContent className="space-y-6">
            <div className="bg-slate-50 p-8 rounded-lg min-h-[300px] flex items-center justify-center">
              <p className="text-gray-500 text-center">Le contenu de l'énigme 4 DE BARON sera ajouté ici</p>
            </div>
